...
export const {
  ...
  setFormSuccess,
  resetForm,
} = approveRequestSlice.actions;

export const approveRequestSubmit = (transactionId) => {
  return async (dispatch) => {
    try {
      dispatch(setFormLoading());
      await axios.post(`${baseUrl}/api/transaction/approve`, { transaction_id: transactionId }, setConfig());
