...
export const {
  ...
  setFormSuccess,
  resetForm,
} = requestBookSlice.actions;

export const requestBookSubmit = (bookId) => {
  return async (dispatch) => {
    try {
      dispatch(setFormLoading());
      await axios.post(`${baseUrl}/api/transaction/request`, { book_id: bookId }, setConfig());
